...
const App: React.FC = () => {
  ...
  const [emergencyContacts, setEmergencyContacts] = useState<Contact[]>([
    { id: '1', name: 'Rahul (Husband)', phone: '+91 91234 56789', priority: 'Primary' },
    { id: '2', name: 'Sneha (Sister)', phone: '+91 98765 43210', priority: 'Emergency' }
  ]);
